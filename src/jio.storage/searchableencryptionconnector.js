...
(function (dependencies, module) {
  ...
  /**
  * SearchableEncryptionStorageConnector is a function that creates
...
//Copied from the davstorage connector
 ...
 //   this.postOrPut('put', command, metadata);
   ...
   * @param  {Object} options The command options
   */
  SearchableEncryptionStorageConnector.prototype.putAttachment = function (
    command,
    param
  ) {
    jIO.util.ajax({
  ...
  * @param  {Object} options The command options
  */
  SearchableEncryptionStorageConnector.prototype.get = function (
    command,
    param
  ) {
  ...
  SearchableEncryptionStorageConnector.prototype.getAttachment = function (
    command,
    param
  ) {
    jIO.util.ajax({
  ...
  SearchableEncryptionStorageConnector.prototype.remove = function (
    command,
    param
  ) {
    jIO.util.ajax({
  ...
  SearchableEncryptionStorageConnector.prototype.removeAttachment = function (
    command,
    param
  ) {
    jIO.util.ajax({
